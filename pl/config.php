...
//表格属性
$objPHPExcel->getProperties()->setCreator("吾幼内控管理系统")->setTitle("PL表")->setSubject("年度中心损益表");
...
//标题
$objPHPExcel->getActiveSheet()->setCellValue('A1', date('Y') . '中心年度损益表');
